...
MACRO(MACRO_ENSURE_VERSION requested_version found_version var_too_old)
  ...
  IF(${requested_version} MATCHES "[0-9]+\\.[0-9]+\\.[0-9]+")
    STRING(REGEX REPLACE "[0-9]+\\.[0-9]+\\.([0-9]+)" "\\1" req_patch_vers "${requested_version}")
  ELSE(${requested_version} MATCHES "[0-9]+\\.[0-9]+\\.[0-9]+")
    SET(req_patch_vers 0)
  ENDIF(${requested_version} MATCHES "[0-9]+\\.[0-9]+\\.[0-9]+")
  ...
  ELSE(${found_version} MATCHES "[0-9]+\\.[0-9]+\\.[0-9]+")
    SET(found_patch_vers 0)
  ENDIF(${found_version} MATCHES "[0-9]+\\.[0-9]+\\.[0-9]+")
